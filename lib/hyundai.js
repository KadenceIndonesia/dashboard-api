...
global.getDealerByPid = function (pid, city, dealer) {
  return new Promise((resolve) => {
    if (city) {
      Dealer.find({ idProject: pid, idCity: city, idDealer: { $in: dealer } })
        .exec()
        .then((result) => {
          resolve(result);
        })
...
global.scoreTouchPointByParent = function (pid, code, arrayDealer) {
  return new Promise((resolve) => {
...
global.scoreTouchPointByParentDealer = function (pid, dealer) {
  return new Promise((resolve) => {
    Touchpointscore.find({
      idProject: pid,
      idDealer: dealer,
...
global.scoreTouchPointByRegion = function (pid, code, region) {
  return new Promise((resolve) => {
    Touchpointscore.find({
      idProject: pid,
      code: code,
