...
global.getbaseTahap = function (kode) {
  var result = 0
  for (let i = 0; i < dataPropana.length; i++) {
    if(dataPropana[i].tahap === parseInt(kode)){
      result = result + dataPropana[i].target
    }
  }
  return result;
};
global.getBasePangkalanTahap = function (kode) {
  var result = 0
  for (let i = 0; i < dataPropana.length; i++) {
    if(dataPropana[i].tahap === parseInt(kode)){
      result = result + dataPropana[i].pangkalan
    }
  }
  return result;
};

global.getbaseMor = function (kode) {
  var result = 0
  for (let i = 0; i < dataPropana.length; i++) {
    if(dataPropana[i].regCode === parseInt(kode)){
      result = result + dataPropana[i].target
    }
  }
  return result;
...
global.getbasePangkalanMor = function (kode) {
  var result = 0
  for (let i = 0; i < dataPropana.length; i++) {
    if(dataPropana[i].regCode === parseInt(kode)){
      result = result + dataPropana[i].pangkalan
...
global.getbaseKabupaten = function (kode) {
  var result = 0
  for (let i = 0; i < dataPropana.length; i++) {
    if(dataPropana[i].kabCode === parseInt(kode)){
      result = result + dataPropana[i].target
    }
  }
  return result;
};
global.getbasePangkalanKabupaten = function (kode) {
  var result = 0
  for (let i = 0; i < dataPropana.length; i++) {
    if(dataPropana[i].kabCode === parseInt(kode)){
      result = result + dataPropana[i].pangkalan
...
global.getbaseKelurahan = function (kode) {
  var result = 0
  for (let i = 0; i < dataPropana.length; i++) {
    if(dataPropana[i].code === parseInt(kode)){
      result = result + dataPropana[i].target
    }
  }
  return result;
};
global.getbasePangkalanKelurahan = function (kode) {
  var result = 0
  for (let i = 0; i < dataPropana.length; i++) {
    if(dataPropana[i].code === parseInt(kode)){
      result = result + dataPropana[i].pangkalan
...
global.getAllOccupation = function () {
  var result = occupation
  return result;
};
